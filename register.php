...
if (isset($_GET['terms'])) {
    ...
    } else if ($_GET['email'] == "repeat") {
        $emailError = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <strong>Email already exists. Please enter another email id.</strong>
                      <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                     <span aria-hidden="true">&times;</span>
                    </button>
                    </div>';
    ...
    } else if ($_GET['id'] == "repeat") {
        $idError = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <strong>ID number already exists in acceptor or donor database. Enter a unique ID number.</strong>
                      <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                     <span aria-hidden="true">&times;</span>
                    </button>
                    </div>';
    }
} else if (isset($_GET['my_image'])) {
    if ($_GET['my_image'] == 'large') {
        $imgError = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                <strong>Sorry, your file is too large.</strong>
                  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                 <span aria-hidden="true">&times;</span>
                </button>
                </div>';
    } else if ($_GET['my_image'] == "type") {
        $imgError = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <strong>You can only upload jpg, jpeg or png file.</strong>
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                    </div>';
    } else if ($_GET['my_image'] == "unknown") {
        $imgError = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
    ...
    } else if ($_GET['my_image'] == "empty") {
        $imgError = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <strong>Please upload an ID file.</strong>
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                    </div>';
    ...
    } else if ($_GET['username'] == "repeat") {
        $usernameError = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <strong>Username already exists. Please enter another username.</strong>
                      <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                     <span aria-hidden="true">&times;</span>
                    </button>
                    </div>';
...
<body>
    ...
    <div class="splash-container">
        <div class="card">
            ...
            ?>
            <div class="card-body">
                <form class="form-group" action="validate.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <input class="form-control form-control-lg" type="text"
                            placeholder="Citizenship ID (in numbers only.)" autocomplete="on" name="id">
                        <?php
                    ...
                    <div class="uploadform">
                        ...
                        <div>
                            ...
                            <label for="" style="padding-top: 10px; padding-bottom: 10px;">Upload
                                an image file:</label>
                            <input type="file" style="text-align: center; " name="my_image">
                        </div>
