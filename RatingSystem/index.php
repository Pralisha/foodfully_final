    ...
    $(document).ready(function () {
        ...
        $('#save_review').click(function () {
            ...
            if (user_name == '' || user_review == '') {
                ...
                $.ajax({
                    url: "../RatingSystem/submit_rating.php?username=<?php echo $_GET['username']; ?>",
                    method: "POST",
                ...
                success: function (data) {
                    ...
                    if (data.review_data.length > 0) {
                        ...
                        for (var count = 0; count < data.review_data.length; count++) {
                            ...
                            html += '<div class="col-sm-1"><div class="text-white pt-2 pb-2"><img style="border-radius: 50%; width:75px; height:75px" src="../profile_pic/' + data.review_data[count].img_path + '"></div></div>';
