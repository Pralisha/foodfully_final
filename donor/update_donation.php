                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="add.php" style="background-color: #b6991786;"><i class="fa fa-fw fa-hands-helping"></i>Add Donation <span class="badge badge-success">6</span></a>
                            </li>
                            <li class="nav-item ">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                             <h2 class="pageheader-title"><i class="fa fa-fw fa-hands-helping"></i> Update Donations </h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="validationform" data-parsley-validate="" novalidate="" action="submission_update.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">        
                                        <div class="form-group row">
                                                  
                                            <label class="col-12 col-sm-3 col-form-label text-sm-right">Title</label>
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input data-parsley-type="alphanum" type="text" value="<?php echo $title; ?>" placeholder="" class="form-control" name="title">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                ...
                                                <textarea class="form-control" input name="description" value="<?php echo $description; ?>" ><?php echo $description; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-right">Best Before Date</label>
                                            <div class="col-12 col-sm-8 col-lg-6">
                        
                                                <input type="date" class="form-control" input name="best_before_date" value="<?php echo $best_before; ?>" >
                                            </div>
                                        </div>
                                        <div class="form-group row"><label class="col-12 col-sm-3 col-form-label text-sm-right" style="" >Image file</label>
                                        <div class="col-12 col-sm-8 col-lg-6">
                                        <img src="donation_img/<?php echo $image_donation;?> " style="width:400px; ">
                                        <input type="hidden" value="<?php echo $image_donation;?> " name="default_img"> 
                                        <input type="file" style="cursor: pointer; box-shadow:none;" name="my_image" > 
                                        ...
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <div class="row justify-content-md-center">
                                                ...
                                                <input data-parsley-type="alphanum" input id="search" type=" text"
                                                    required="" placeholder="" class="form-control" name="location" value="<?php echo $pickup; ?>">
                                    ...
                                    <script src="../js/indexdonor.js">
                                        ...
                                        <div class="form-group row text-right">
                                            <div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
                                                ...
                                                <a href="donation.php"><button type="button"class="btn btn-space btn-secondary">Cancel</button></a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
